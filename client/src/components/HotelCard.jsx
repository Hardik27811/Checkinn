...
function HotelCard({room,index}) {
  return (
    <Link to={`/rooms?hotelId=${room._id}`} onClick={()=> scrollTo(0,0)} key={room._id} className='relative max-w-70 w-full rounded-xl overflow-hidden bg-white text-gray-500/90 shadow-[0px_4px_4px_rgba(0,0,0,0.05)]'>
        <img src={room.hotelImage[0]} alt=""/>
        ...
        <div className='p-4 pt-5'>
            ...
            <div className='flex items-center justify-between mt-4'>
                {/* <p>
                 ...
                 <p>
                    <span className='text-sm text-gray-800'>{room.description.slice(0,18)}</span>
                </p>
